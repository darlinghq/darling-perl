...
if test ! -f Makefile -a -f Makefile.old; then
    ...
    make -f Makefile.old realclean MAKE='/Applications/Xcode.app/Contents/Developer/usr/bin/make' PERL_CORE=1 LIBPERL_A=libperl.dylib
else
    if test ! -f Makefile ; then
	echo "Warning: No Makefile!"
    fi
    /Applications/Xcode.app/Contents/Developer/usr/bin/make realclean MAKE='/Applications/Xcode.app/Contents/Developer/usr/bin/make' PERL_CORE=1 LIBPERL_A=libperl.dylib
fi
cd ../..
...
if test ! -f Makefile -a -f Makefile.old; then
    echo "Note: Using Makefile.old"
    make -f Makefile.old realclean MAKE='/Applications/Xcode.app/Contents/Developer/usr/bin/make' PERL_CORE=1 LIBPERL_A=libperl.dylib LINKTYPE=static
else
    if test ! -f Makefile ; then
	echo "Warning: No Makefile!"
    fi
    /Applications/Xcode.app/Contents/Developer/usr/bin/make realclean MAKE='/Applications/Xcode.app/Contents/Developer/usr/bin/make' PERL_CORE=1 LIBPERL_A=libperl.dylib LINKTYPE=static
fi
cd ../..
cd ext/B
if test ! -f Makefile -a -f Makefile.old; then
    echo "Note: Using Makefile.old"
    make -f Makefile.old realclean MAKE='/Applications/Xcode.app/Contents/Developer/usr/bin/make' PERL_CORE=1 LIBPERL_A=libperl.dylib LINKTYPE=dynamic
else
    if test ! -f Makefile ; then
	echo "Warning: No Makefile!"
    fi
    /Applications/Xcode.app/Contents/Developer/usr/bin/make realclean MAKE='/Applications/Xcode.app/Contents/Developer/usr/bin/make' PERL_CORE=1 LIBPERL_A=libperl.dylib LINKTYPE=dynamic
fi
cd ../..
