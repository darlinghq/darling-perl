...
;
	int	ign_err;
#line 245 "DynaLoader.xs"
    void *sym;
#line 432 "DynaLoader.c"
...
XS_EUPXS(XS_DynaLoader_dl_undef_symbols)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 266 "DynaLoader.xs"
#line 470 "DynaLoader.c"
    }
    XSRETURN_EMPTY;
}
