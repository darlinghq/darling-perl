...
XS_EUPXS(XS_Storable_init_perinterp)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 7806 "Storable.xs"
    init_perinterp(aTHX);
#line 7946 "Storable.c"
    }
    XSRETURN_EMPTY;
}
...
#line 7858 "Storable.xs"
    RETVAL = pretrieve(aTHX_ f, flag);
#line 8023 "Storable.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
#line 7867 "Storable.xs"
    RETVAL = mretrieve(aTHX_ sv, flag);
#line 8051 "Storable.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
;
	SV *	RETVAL;
#line 7875 "Storable.xs"
    RETVAL = dclone(aTHX_ sv);
#line 8071 "Storable.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
XS_EUPXS(XS_Storable_last_op_in_netorder)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 7885 "Storable.xs"
    bool result;
#line 8089 "Storable.c"
#line 7887 "Storable.xs"
    if (ix) {
        dSTCXT;
        assert(cxt);
