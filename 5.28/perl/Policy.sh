...
case "$perladmin" in
'') perladmin='ariel@ari-pavilion.cfl.rr.com' ;;
esac
...
privlib='/System/Library/Perl/5.28'
# archlib='/System/Library/Perl/5.28/darwin-thread-multi-2level'
...
sitelib='/Library/Perl/5.28'
# sitearch='/Library/Perl/5.28/darwin-thread-multi-2level'
...
vendorlib='/Network/Library/Perl/5.28'
