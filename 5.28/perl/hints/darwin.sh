...
# INT32_MIN is set in ${SDKROOT}/usr/include/stdint.h by:
# #define INT32_MIN        -2147483648
...
# -- Edward Moy
#
if test -f ${SDKROOT}/usr/include/stdint.h; then
  case "$(grep '^#define INT32_MIN' ${SDKROOT}/usr/include/stdint.h)" in
...
# hints.append
#-------------------------------------------------------------------------
_v_="${perl_revision}.${perl_version}"
prefix=/
privlib="/System/Library/Perl/${_v_}"
sitelib="/Library/Perl/${_v_}"
vendorlib="/Network/Library/Perl/${_v_}"
