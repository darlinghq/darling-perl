...
#line 6543 "Storable.c"

XS_EUPXS(XS_Storable__Cxt_DESTROY); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Storable__Cxt_DESTROY)
{
    dVAR; dXSARGS;
    if (items != 1)
