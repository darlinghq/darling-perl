 ...
 */
#define I_NDBM	/**/
// Darling note: had to manually edit this because the configure script was incorrectly detecting it as available
/*#define I_GDBMNDBM	/ **/
/*#define I_GDBM_NDBM	/ **/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/Library/Perl/5.18/darwin-thread-multi-2level"		/**/
#define SITEARCH_EXP "/Library/Perl/5.18/darwin-thread-multi-2level"		/**/
 ...
 */
#define SITELIB "/Library/Perl/5.18"		/**/
#define SITELIB_EXP "/Library/Perl/5.18"		/**/
#define SITELIB_STEM "/Library/Perl/5.18"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define PERL_VENDORARCH "/Network/Library/Perl/5.18/darwin-thread-multi-2level"		/**/
#define PERL_VENDORARCH_EXP "/Network/Library/Perl/5.18/darwin-thread-multi-2level"		/**/
 ...
 *	be tacked onto this variable to generate a list of directories to search.
 */
#define PERL_VENDORLIB_EXP "/Network/Library/Perl/5.18"		/**/
#define PERL_VENDORLIB_STEM "/Network/Library/Perl/5.18"		/**/
