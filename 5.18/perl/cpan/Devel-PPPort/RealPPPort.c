...
XS_EUPXS(XS_Devel__PPPort_SvPV_force_flags_nolen)
{
	...
	SV *	sv = ST(0)
;
#line 1685 "RealPPPort.xs"
		char *str;
#line 3271 "RealPPPort.c"
	IV	RETVAL;
	dXSTARG;
#line 1687 "RealPPPort.xs"
