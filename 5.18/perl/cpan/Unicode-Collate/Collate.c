...
XS_EUPXS(XS_Unicode__Collate__isNonchar); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Unicode__Collate__isNonchar)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "sv");
...
XS_EUPXS(XS_Unicode__Collate_unpack_U); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Unicode__Collate_unpack_U)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "src");
