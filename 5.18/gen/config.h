...
/* Package name      : perl5
 * Source directory  : .
 * Configuration time: Mon Jan 16 19:00:28 PST 2017
 * Configured by     : andyhyatt
 * Target system     : darwin andrewhyatt-mac.local 16.3.0 darwin kernel version 16.3.0: thu nov 17 20:23:58 pst 2016; root:xnu-3789.31.2~1release_x86_64 x86_64 
 */
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/lib/perl5/site_perl/5.18.2/darwin-thread-multi-2level"		/**/
#define SITEARCH_EXP "/usr/lib/perl5/site_perl/5.18.2/darwin-thread-multi-2level"		/**/
