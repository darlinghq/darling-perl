 ...
 */
#define	PERL_PREPENDTOPATH	"/Library/Perl/5.18/PrependToPath"

/* PERL_APPENDTOPATH:
 *	If defined, this is the path to a file containing colon-separated
 *	paths to append to @INC.
 */
#define	PERL_APPENDTOPATH	"/Library/Perl/5.18/AppendToPath"
 ...
 */
#define NO_NETWORK_LIBRARY_PERL_FILE	"/Library/Perl/5.18/No_Network_Library_Perl"
