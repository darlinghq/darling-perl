...
package	Namespace	Modules	Objects	declare a separate global namespace
...
use	Namespace	Modules	Objects	load in a module at compile time and import its namespace
